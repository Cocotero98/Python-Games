...
class Game(arcade.Window):
    ...
    def create_target(self):
        ...
        standard_target=StandardTarget()
        strong_target=StrongTarget()
        random_number=random.randint(1,3)
        if random_number==1:
            self.bullets.append(safe_target)
        ...
        for bullet in self.bullets:
            for target in self.targets:
                ...
                if bullet.alive and target.alive:
                    ...
                    if (abs(bullet.center.get_x() - target.center.get_x()) < too_close and
                                abs(bullet.center.get_y() - target.center.get_y()) < too_close):
                        # its a hit!
                        bullet.alive = False
